<!DOCTYPE html>
<?php
include('conexionplantrabajo.php');

$tmp = array();
$res = array();

$sel = $con->query("SELECT * FROM trabajo");
      ...
      <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
          <div class="nav">
            ...
            <a class="nav-link collapsed" href="dashboard.php" data-toggle="collapse" data-target="#collapseLayouts"
    ...
    <div id="layoutSidenav_content">
      <main>
        <div class="container-fluid">
          <h1 class="mt-4">Plan de Trabajo</h1>
