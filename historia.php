  ...
  <div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
	  ...
	  <div class="container">
			...
			<form class="form-horizontal" method="POST" action="guardarhistoria.php" autocomplete="off" >
				<div class="form-group">
					<label for="mantenimiento" class="col-sm-2 control-label">Mantenimientos Realizados</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" id="mantenimiento" name="mantenimiento" placeholder="Mantenimientos Realizados" required>
					</div>
				</div>
				
				<div class="form-group">
					<label for="repuestos" class="col-sm-2 control-label">Repuestos Utilizados</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" id="repuestos" name="repuestos" placeholder="Repuestos Utilizados" required>
					</div>
				</div>
				
				<div class="form-group">
					<label for="observaciones" class="col-sm-2 control-label">Campo De  Observaciones</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" id="observaciones" name="observaciones" placeholder="Campo De  Observaciones">
					</div>
				</div>
